<%-- 
    ...
    Created on : Jul 7, 2023, 9:53:08 PM
    Author     : Quang Huy
--%>
            ...
            <div  class="sticky">
                ...
                <div style="float: left" class="backToHome">
                    <a href="loginAd?admin_name=${admin_name}&mod=1">
                        <font style="font-family: sans-serif; font-size: 12px; color: black">Back &nbsp;|<b>Student FeedBack</b></font>
                    </a>
                </div>
            </div>
            ...
            <c:forEach items="${accountList}" var="a">
                <c:forEach items="${commentList}" var="c">
                    <c:forEach items="${teacherList}" var="t">
                        <c:choose>
                            <c:when test="${a.getAccount_id() eq c.getAccount_id() && c.getTeacher_id() eq t.getTeacher_id()}">
                                <tr>
