<%-- 
    Document   : signIn
    Created on : Jul 3, 2023, 9:20:12 AM
    Author     : Quang Huy
--%>
...
<html>
    ...
    <body>
        ...
        <!--        <a class="backToHome" href="listAddress">Home</a>-->
        <div class="container" style="margin-top: 40px">

            <form action="login" method="post">
                <div class="text-center">
                    <h1 class="mauxanh">Member SignIn</h1>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col">
                        <a href="signInAdmin.jsp">Sign In as Administator</a>
                    </div>

                    <div  class="col">
                        <a href="signInTeacher.jsp">Sign In as Teacher</a>
                    </div>
                </div>
                <!-- Gọi đến doPost cua LoginController(controller) -->
                <button type="submit" class="btn btn-block mb-4">Sign In</button>

                <!-- Sign in by Facebook or Twitter -->
                <div class="text-center">
                    <p>Or sign up with:</p>
